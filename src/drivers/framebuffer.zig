...
pub const FrameBuffer = struct {
    ...
    pub fn init(
        ...
        if (boot_info.getTag(multiboot.TagFrameBufferInfo)) |tag| {
            ...
            const vbuf: ?[*]u32 = switch (mode) {
                .double_buffered => mm.kmallocArray(u32, tag.height * tag.pitch / 4),
                .zero_copy => null,
            };
            ...
            var fb = FrameBuffer{
                ...
                .width = tag.width,
                .height = tag.height,
                .total_pixels = tag.height * stride,
    ...
    inline fn buffer(self: *FrameBuffer) [*]u32 {
        return switch (self.mode) {
            .double_buffered => self.virtual_buffer.?,
