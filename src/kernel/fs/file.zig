...
pub const FileOps = struct {
    ...
    poll: ?*const fn (base: *File, pollfd: *kernel.poll.PollFd, poll_table: ?*kernel.poll.PollTable) anyerror!u32 = pollVFS,
...
pub fn pollVFS(
    _: *fs.File,
    pollfd: *kernel.poll.PollFd,
    _: ?*kernel.poll.PollTable
) !u32 {
