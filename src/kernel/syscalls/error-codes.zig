...
pub const ENOSYS		= 38; // Invalid system call number
...
pub const ESTALE		= 116; // Stale file handle
...
pub const ECANCELED	= 125; // Operation Canceled
pub const ENOKEY		= 126; // Required key not available
pub const EKEYEXPIRED	= 127; // Key has expired
pub const EKEYREVOKED	= 128; // Key has been revoked
pub const EKEYREJECTED	= 129; // Key was rejected by service
pub const EOWNERDEAD	= 130; // Owner died
pub const ENOTRECOVERABLE	= 131; // State not recoverable
pub const ERFKILL		= 132; // Operation not possible due to RF-kill
pub const EHWPOISON	= 133; // Memory page has hardware error
