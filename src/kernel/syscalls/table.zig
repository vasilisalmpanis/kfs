...
pub const SyscallTable = brk: {
    ...
    break :brk std.EnumMap(Syscall, *const SyscallHandler).init(.{
        ...
        .SYS_waitpid                    = &notImpl,
        .SYS_creat                      = &notImpl,
        .SYS_link                       = @ptrCast(&@import("link.zig").link),
        .SYS_unlink                     = @ptrCast(&@import("unlink.zig").unlink),
        ...
        .SYS_lchown                     = @ptrCast(&@import("chown.zig").lchown),
        .SYS_break                      = &notImpl,
        .SYS_oldstat                    = &notImpl,
        ...
        .SYS_pause                      = &notImpl,
        .SYS_utime                      = &notImpl,
        // .SYS_utimensat                  = @ptrCast(&@import("time.zig")),
        .SYS_stty                       = &notImpl,
        .SYS_gtty                       = &notImpl,
        ...
        .SYS_rename                     = @ptrCast(&@import("rename.zig").rename),
        .SYS_renameat                   = @ptrCast(&@import("rename.zig").renameat),
        .SYS_renameat2                  = @ptrCast(&@import("rename.zig").renameat2),
        .SYS_mkdir                      = @ptrCast(&@import("mkdir.zig").mkdir),
        .SYS_rmdir                      = @ptrCast(&@import("mkdir.zig").rmdir),
        .SYS_dup                        = @ptrCast(&@import("dup.zig").dup),
        .SYS_pipe                       = @ptrCast(&@import("pipe.zig").pipe),
        .SYS_pipe2                      = @ptrCast(&@import("pipe.zig").pipe2),
        .SYS_times                      = &notImpl,
        .SYS_prof                       = &notImpl,
        ...
        .SYS_readlink                   = @ptrCast(&@import("readlink.zig").readlink),
        .SYS_uselib                     = &notImpl,
        .SYS_swapon                     = &notImpl,
        .SYS_reboot                     = &notImpl,
        .SYS_readdir                    = &notImpl,
        ...
        .SYS_ftruncate64                = @ptrCast(&@import("truncate.zig").ftruncate64),
        .SYS_fchmod                     = &notImpl,
        .SYS_fchown                     = &notImpl,
        .SYS_fchownat                    = @ptrCast(&@import("chown.zig").fchownat),
        ...
        .SYS_uname                      = @ptrCast(&@import("uname.zig").uname),
        ...
        .SYS_nanosleep                  = @ptrCast(&@import("sleep.zig").nanosleep),
        .SYS_mremap                     = &notImpl,
        .SYS_setresuid                  = &notImpl,
        .SYS_getresuid                  = &notImpl,
        .SYS_vm86                       = &notImpl,
        .SYS_query_module               = &notImpl,
        .SYS_poll                       = @ptrCast(&@import("poll.zig").poll),
        .SYS_nfsservctl                 = &notImpl,
        .SYS_setresgid                  = &notImpl,
        .SYS_getresgid                  = &notImpl,
        .SYS_prctl                      = &notImpl,
        .SYS_rt_sigreturn               = @ptrCast(&@import("./sigaction.zig").rt_sigreturn),
        ...
        .SYS_pwrite                     = &notImpl,
        .SYS_chown                      = &notImpl,
        .SYS_chown32                    = @ptrCast(&@import("chown.zig").chown32),
