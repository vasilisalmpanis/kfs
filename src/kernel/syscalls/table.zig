...
pub const SyscallTable = brk: {
    ...
    break :brk std.EnumMap(Syscall, *const SyscallHandler).init(.{
        ...
        .SYS_getpgrp                    = @ptrCast(&@import("../sched/process.zig").getPGID),
        .SYS_setsid                     = &notImpl,
        ...
        .SYS_reboot                     = &notImpl,
        .SYS_readdir                    = &notImpl,
        .SYS_mmap                       = @ptrCast(&@import("./mmap.zig").mmap2),
        ...
        .SYS_nanosleep                  = @ptrCast(&@import("./nanosleep.zig").nanosleep),
        .SYS_mremap                     = &notImpl,
        ...
        .SYS_geteuid32                  = @ptrCast(&@import("../sched/process.zig").getUID),
        .SYS_mknodat                    = &notImpl,
        ...
        .SYS_getegid32                  = @ptrCast(&@import("../sched/process.zig").getUID),
        ...
        .SYS_fcntl64                    = @ptrCast(&@import("dup.zig").fcntl64),
    });
};
