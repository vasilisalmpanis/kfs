...
pub const SyscallTable = brk: {
    ...
    break :brk std.EnumMap(Syscall, *const SyscallHandler).init(.{
        ...
        .SYS_exit_group                 = @ptrCast(&krn.syscalls.exit.exit_group),
        ...
        .SYS_uselib                     = &notImpl,
        .SYS_swapon                     = &notImpl,
        .SYS_reboot                     = @ptrCast(&krn.syscalls.reboot.reboot),
        .SYS_readdir                    = &notImpl,
        ...
        .SYS_socket                     = @ptrCast(&krn.syscalls.socketcall.socket),
        .SYS_bind                       = @ptrCast(&krn.syscalls.socketcall.bind),
        .SYS_connect                    = @ptrCast(&krn.syscalls.socketcall.connect),
        .SYS_listen                     = @ptrCast(&krn.syscalls.socketcall.listen),
        .SYS_accept4                    = @ptrCast(&krn.syscalls.socketcall.accept4),
